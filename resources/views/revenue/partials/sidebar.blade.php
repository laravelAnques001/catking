                ...
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="disabled"><a href="../../../layout_6/LTR/default/index.html"
                    ...
                    <li><a href="changelog.html"><i class="icon-list-unordered"></i> <span>Changelog <span
                                    class="label bg-blue-400">1.5</span></span></a></li>
                    <li><a href="../../RTL/default/index.html"><i class="icon-width"></i> <span>RTL version</span></a>
                    </li>
                    <!-- /main -->
                    ...
                    <li>
                        <a href="#"><i class="icon-alignment-unalign"></i> <span>Data tables
                                extensions</span></a>
                        <ul>
                    ...
                    <!-- Page kits -->
                    <li class="navigation-header"><span>Page kits</span> <i class="icon-menu" title="Page kits"></i>
                    </li>
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="disabled"><a href="general_widgets_stats.html">Statistics widgets <span
                                        class="label label-transparent">in 1.6</span></a></li>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li class="disabled">
                                <a href="#">Ecommerce set <span class="label label-transparent">in
                                        1.6</span></a>
                                <ul>
