            ...
            require(
                ...
                function(ec, limitless) {
                    ...
                    total_revenue_options = {
                        ...
                        xAxis: [{
                            type: 'category',
                            data: ['IIM WAT PI', 'Top B-School GDPI', 'NMIMS WAT PI']
                        }],
                ...
                <div class="panel-heading border-radius-15">
                    ...
                    <div class="heading-elements">
                        <div class="heading-text">
                            ...
                            <span
                                class="status-mark border-cornBlue-theme-300 bg-cornBlue-theme-300 position-left ml-5"></span>Last
                            Day
                        </div>
                    </div>
                </div>
