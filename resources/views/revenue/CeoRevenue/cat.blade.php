            ...
            require(
                ...
                function(ec, limitless) {
                    ...
                    total_revenue_options = {
                        ...
                        xAxis: [{
                            type: 'category',
                            data: ['Intensive 2023', 'Turbo 2023', 'Self study course 2023',
                                'IIT/NIT', 'Repeaters', 'Non- Engineer', 'Books and mocks',
                                'Quants', 'Verbal', 'DILR', 'Intensive 2024', 'Turbo 2024',
                                'CAT2024+GMAT'
                            ]
                        }],
                    ...
                    no_of_enrollment_options = {
                        ...
                        series: [{
                                name: 'Today',
                                type: 'bar',
                                data: [7, 5, 4, 2, 3, 6, 2, 4, 4, 5, 3, 2, 4],
                                itemStyle: {
                                    normal: {
                                        color: '#6186FF',
                                        label: {
                            ...
                            },
                            {
                                name: 'Last Day',
                                type: 'bar',
                                data: [8, 6, 3, 3, 4, 5, 1, 2, 3, 6, 1, 4, 3],
                                itemStyle: {
                                    normal: {
                                        color: '#BFCEFF',
                                        label: {
        ...
        <div class="panel-heading border-radius-15">
            ...
            <div class="heading-elements">
                <div class="heading-text">
                    ...
                    <span class="status-mark border-cornBlue-theme-300 bg-cornBlue-theme-300 position-left ml-5"></span>Last Day
                </div>
            </div>
        </div>
        <div class="panel-body">
